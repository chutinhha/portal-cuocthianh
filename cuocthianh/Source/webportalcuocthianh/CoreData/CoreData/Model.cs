...
namespace CoreData
{
    public class Model
    {
        ...
        public List<SelectListItem> ListManufacturerExt;
        public string ManufacturerExt { get; set; }
        public Model()
        {
            Code = "";
            Name = "";
        ...
        static Model DynamicCast<T>(object row_data, object row_header) where T : Model
        {
            // row_data : DataRow
            ...
            foreach (DataColumn column in (DataColumnCollection)row_header)
            {
                switch (column.ColumnName)
                {
                    ...
                    case "Name":
                        ...
                        break;
                    case "ManufacturerID":
                        ret.ManufacturerID = ConvertObject.ToLong(dt[column]);
                        break;
                    case "Image":
                    ...
                    case "ManufacturerName":
                        ret.ManufacturerExt = ConvertObject.ToString(dt[column]);
                        break;
                    case "Active":
